...
app.post('/webhook', async (req, res) => {
  ...
  if (event.type === 'checkout.session.completed') {
    ...
    const name = session.customer_details.name || 'Unknown'; // Get the customer's name
    ...
    try {
      ...
      const airtableResponse = await axios.post('https://api.airtable.com/v0/appXwEBSWkI5b6Hos/BIAW', {
        fields: {
          'Name': name,
      ...
      console.log('Data successfully sent to Airtable:', airtableResponse.data);
